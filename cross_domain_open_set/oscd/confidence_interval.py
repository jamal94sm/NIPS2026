...
# identity_bootstrap_ci now lives in utils.py (shared, method-agnostic) --
# re-exported here so existing `from confidence_interval import
# identity_bootstrap_ci` call sites elsewhere keep working unchanged.
identity_bootstrap_ci = U.identity_bootstrap_ci
