...
# ─────────────────────────────────────────────────────────────────
MPD_RAW_DIR = "/path/to/MPD_RAW"
CHSST_CKPT  = "/path/to/EP7-iou0.951562-pacc0.977916.pth"
LANET_CKPT  = "/path/to/LANet_v1.pkl"
SEG_TMP_DIR = "/tmp/MPD_segmented"        # intermediate; can be /tmp
ROI_OUT_DIR = "/path/to/ROIs/MPD"         # ← main output
VIS_OUT_DIR = "/path/to/ROIs/MPD_vis"     # circle debug visualisations
